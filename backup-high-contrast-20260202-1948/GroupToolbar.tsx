...
export const GroupToolbar: React.FC<GroupToolbarProps> = ({
  ...
  return (
    <div
      className="fixed z-50 flex items-center gap-0.5 px-1.5 py-1 bg-white border border-gray-200 rounded-lg shadow-lg pointer-events-auto"
      style={{
        left: `${toolbarX}px`,
        top: `${toolbarY}px`,
    ...
    >
      ...
      <div className="relative">
        <button
          className="p-1 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors flex items-center gap-0.5"
          onClick={() => {
        ...
        {isAlignMenuOpen && (
          <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg p-1 min-w-[140px] animate-in fade-in zoom-in-95 duration-200">
            <button
              className="w-full text-left px-2 py-1.5 text-[10px] font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded flex items-center gap-1.5 transition-colors"
              onClick={() => {
                onAlignLeft(groupId);
            ...
            >
              <AlignLeft size={12} />
              <span>左对齐</span>
              <span className="ml-auto text-[8px] text-gray-400">Alt+A</span>
            </button>
            ...
            >
              ...
              <span>水平居中</span>
              <span className="ml-auto text-[8px] text-gray-400">Alt+H</span>
            </button>
            ...
            >
              <AlignRight size={12} />
              <span>右对齐</span>
              <span className="ml-auto text-[8px] text-gray-400">Alt+D</span>
            </button>
            ...
            >
              ...
              <span>顶部对齐</span>
              <span className="ml-auto text-[8px] text-gray-400">Alt+W</span>
            </button>
            ...
            >
              ...
              <span>垂直居中</span>
              <span className="ml-auto text-[8px] text-gray-400">Alt+V</span>
            </button>
        ...
        {isDistributeMenuOpen && (
          <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg p-1 min-w-[140px] animate-in fade-in zoom-in-95 duration-200">
            ...
            >
              ...
              <span>水平间距</span>
              <span className="ml-auto text-[8px] text-gray-400">Shift+H</span>
            </button>
            ...
            >
              ...
              <span>垂直间距</span>
              <span className="ml-auto text-[8px] text-gray-400">Shift+V</span>
            </button>
