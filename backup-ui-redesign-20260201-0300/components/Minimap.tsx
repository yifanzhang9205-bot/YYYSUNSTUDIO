...
export const Minimap: React.FC<MinimapProps> = ({
    ...
    useEffect(() => {
        ...
        ctx.strokeStyle = 'rgba(34, 211, 238, 0.8)'; // 青色
    ...
    return (
        ...
        >
            ...
            >
                {isExpanded ? <Minimize2 size={14} strokeWidth={3} /> : <Map size={14} strokeWidth={3} />}
            </button>
            
            {/* 小地图面板 - 绝对定位，不占用控制栏空间 */}
            {isExpanded && (
                <div className="absolute bottom-16 right-0 bg-[#1c1c1e]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-3 shadow-2xl animate-in fade-in zoom-in-95 duration-300">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <div className="flex items-center gap-1 text-[10px] text-red-400/60 ml-2">
                    ...
                    <canvas
                        ref={canvasRef}
                        className="rounded-lg cursor-pointer bg-black/20"
